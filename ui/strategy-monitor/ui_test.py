...
class TestUIFileStructure(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.required_files = ["index.html", "README.md", "start.sh"]
    ...
    def test_file_permissions(self):
        ...
        for file_name in files_to_check:
            with self.subTest(file_name=file_name):
                ...
                self.assertTrue(
                    os.access(file_path, os.R_OK), f"{file_name} is not readable"
                )
...
class TestHTMLStructure(unittest.TestCase):
    ...
    def test_meta_tags(self):
        ...
        # Arrange
        meta_tags = ['charset="UTF-8"', "viewport"]
    ...
    def test_external_dependencies(self):
        ...
        # Arrange
        external_deps = ["d3.min.js"]

        # Act & Assert
        for dep in external_deps:
            with self.subTest(dep=dep):
                self.assertIn(
                    dep, self.html_content, f"Missing external dependency: {dep}"
                )
...
class TestUIIntegration(unittest.TestCase):
    ...
    def test_css_integration(self):
        ...
        # Arrange
        css_patterns = [r"<style>", r"background", r"color"]

        # Act & Assert
        for pattern in css_patterns:
            with self.subTest(pattern=pattern):
                self.assertIsNotNone(
                    re.search(pattern, self.html_content, re.IGNORECASE),
    ...
    def test_javascript_integration(self):
        ...
        # Arrange
        js_patterns = [r"<script>", r"function", r"const|let|var"]
    ...
    def test_external_library_integration(self):
        ...
        # Arrange
        external_libs = ["d3.min.js", "cdnjs.cloudflare.com"]

        # Act & Assert
        for lib in external_libs:
            with self.subTest(lib=lib):
                self.assertIn(
                    lib, self.html_content, f"Missing external library: {lib}"
                )

    def test_responsive_meta_tags(self):
        """Test that responsive meta tags are present."""
        # Arrange
        responsive_patterns = [r"viewport", r"width=device-width"]
...
class TestUIAccessibility(unittest.TestCase):
    ...
    def test_semantic_elements(self):
        ...
        # Arrange
        semantic_elements = [r"<div", r"<span"]

        # Act & Assert
        for element in semantic_elements:
            with self.subTest(element=element):
                self.assertIsNotNone(
                    re.search(element, self.html_content, re.IGNORECASE),
...
class TestUIPerformance(unittest.TestCase):
    ...
    def test_css_optimization(self):
        ...
        # Arrange
        css_optimization_patterns = [r"<style>", r"background", r"color", r"font"]
