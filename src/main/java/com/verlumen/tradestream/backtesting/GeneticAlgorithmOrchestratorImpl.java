 ...
 * This class coordinates the overall GA optimization process but delegates
...
final class GeneticAlgorithmOrchestratorImpl implements GeneticAlgorithmOrchestrator {
    ...
    public BestStrategyResponse runOptimization(GAOptimizationRequest request) {
        ...
        Any bestParams = genotypeConverter.convertToParameters(best.genotype(), request.getStrategyType());
