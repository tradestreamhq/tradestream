...
public final class App {
    ...
    App(CreateCandles createCandles,
        ...
        logger.atInfo().log("Initialized App with allowedLateness=%s, windowDuration=%s", allowedLateness, windowDuration);
    }
    ...
    private Pipeline buildPipeline(Pipeline pipeline) {
        ...
        // 5. Apply windowing.
        logger.atInfo().log("Applying fixed windowing of duration %s with allowed lateness %s.", windowDuration, allowedLateness);
