...
abstract class PipelineModule extends AbstractModule {
  ...
  protected void configure() {
      ...
      // Install MarketDataModule to provide ExchangeClientUnboundedSource
      install(MarketDataModule.create("coinbase", config().tradeTopic())); // Provide exchangeName and a tradeTopic (might be unused by source)
