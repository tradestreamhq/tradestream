...
sealed class DiscoveredStrategySinkParams {
    data class Postgres(val config: DataSourceConfig) : DiscoveredStrategySinkParams()
    data class Kafka(val bootstrapServers: String, val topic: String) : DiscoveredStrategySinkParams()
