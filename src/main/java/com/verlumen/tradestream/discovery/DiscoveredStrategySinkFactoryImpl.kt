...
class DiscoveredStrategySinkFactoryImpl
    ...
    constructor(
        ...
        override fun create(params: DiscoveredStrategySinkParams): DiscoveredStrategySink = when (params) {
            ...
            is DiscoveredStrategySinkParams.DryRun -> {
                ...
                val dummyConfig = com.verlumen.tradestream.sql.DataSourceConfig(
                    serverName = "dummy",
                    databaseName = "dummy",
                    username = "dummy",
                    password = "dummy",
