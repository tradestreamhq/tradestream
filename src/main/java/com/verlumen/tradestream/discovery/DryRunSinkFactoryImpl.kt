...
class DryRunSinkFactoryImpl @Inject constructor(
    ...
    override fun create(params: DiscoveredStrategySinkParams): DiscoveredStrategySink {
        ...
        val dummyConfig = DataSourceConfig(
            serverName = "dummy", databaseName = "dummy", username = "dummy",
            password = "dummy", portNumber = 5432, applicationName = "dry-run",
            connectTimeout = 30, socketTimeout = 60, readOnly = false,
        )
