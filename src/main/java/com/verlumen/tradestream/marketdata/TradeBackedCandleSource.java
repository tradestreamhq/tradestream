...
/**
 * A CandleSource implementation that creates candles from trade data. This implementation reads
 * trades from a source, assigns timestamps, and converts them to candles.
 */
