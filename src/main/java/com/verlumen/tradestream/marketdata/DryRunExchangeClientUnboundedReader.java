 ...
 */
class DryRunExchangeClientUnboundedReader extends ExchangeClientUnboundedReader {
    ...
    DryRunExchangeClientUnboundedReader(
        DryRunExchangeClientUnboundedSource source,
        TradeCheckpointMark checkpointMark) {
        this.source = source;
