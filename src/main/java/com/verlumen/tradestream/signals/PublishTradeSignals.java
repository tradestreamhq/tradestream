...
public final class PublishTradeSignals
    extends PTransform<PCollection<KV<String, TradeSignal>>, PDone> {
  ...
  private static class PublishSignalsDoFn extends DoFn<KV<String, TradeSignal>, Void> {
    ...
    public void processElement(ProcessContext context) {
      ...
      try {
        logger.atInfo().log(
            "Publishing %s signal for %s at price %f", signal.getType(), key, signal.getPrice());
