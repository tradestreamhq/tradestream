 ...
 *
 * <p>A {@link Currency} object encapsulates the symbol of a currency, which can be used in contexts
...
public record Currency(String symbol) implements Serializable {
   ...
   *
   * @param symbol the symbol of the currency, typically in uppercase and following ISO 4217
   *     standards (e.g., "USD" for US Dollar, "EUR" for Euro, "BTC" for Bitcoin).
