...
/**
 * Interface for maintaining the state for the current strategy and recording performance for all
...
public interface StrategyState extends Serializable {
   ...
   *
   * <p>Implementations of this interface should provide a method to create a new instance of {@code
   * StrategyState}, which is used to initialize the state for a trading strategy.
   */
