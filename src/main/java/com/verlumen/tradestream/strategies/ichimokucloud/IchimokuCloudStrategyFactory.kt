...
class IchimokuCloudStrategyFactory : StrategyFactory<IchimokuCloudParameters> {
    ...
    override fun createStrategy(series: BarSeries, params: IchimokuCloudParameters): Strategy {
        ...
        val entryRule = OverIndicatorRule(closePrice, senkouSpanA)
        ...
        val exitRule = UnderIndicatorRule(closePrice, senkouSpanA)
