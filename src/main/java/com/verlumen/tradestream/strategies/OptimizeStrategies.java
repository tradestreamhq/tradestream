...
/**
 * Composite PTransform that chains the splitting of input records per strategy type with the
 * isolated processing of each strategy type.
 */
final class OptimizeStrategies
    extends PTransform<
        PCollection<KV<String, ImmutableList<Candle>>>, PCollection<KV<String, StrategyState>>> {
  ...
  @Inject
  OptimizeStrategies(
      SplitByStrategyType splitByStrategyType, OptimizeEachStrategyDoFn optimizeEachStrategyDoFn) {
