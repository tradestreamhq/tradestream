...
public final class TickVolumeAnalysisStrategyFactory
    implements StrategyFactory<TickVolumeAnalysisParameters> {

  @Override
  public TickVolumeAnalysisParameters getDefaultParameters() {
    return TickVolumeAnalysisParameters.newBuilder().setTickPeriod(20).build();
  }
  ...
  /**
   * Custom indicator that calculates Tick Volume Analysis. Analyzes the relationship between price
   * ticks and volume to identify market activity.
   */
