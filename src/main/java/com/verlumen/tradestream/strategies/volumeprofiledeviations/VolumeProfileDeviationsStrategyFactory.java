...
public final class VolumeProfileDeviationsStrategyFactory implements StrategyFactory<VolumeProfileDeviationsParameters> {

  @Override
  public VolumeProfileDeviationsParameters getDefaultParameters() {
    return VolumeProfileDeviationsParameters.newBuilder()
        .setPeriod(20)
        .build();
  }
