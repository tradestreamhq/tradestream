...
public final class RegimeChangeEvent {
    ...
    public RegimeChangeEvent(
            RegimeClassification previousRegime,
            RegimeClassification currentRegime,
            int barIndex) {
    ...
    public String toString() {
        return String.format(
                ...
                previousRegime.getRegime(), previousRegime.getConfidence(),
                currentRegime.getRegime(), currentRegime.getConfidence(),
                barIndex);
    }
}
