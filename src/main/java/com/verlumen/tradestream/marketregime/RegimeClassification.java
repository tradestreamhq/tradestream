...
/**
 * Immutable result of a market regime classification, including the detected regime,
 * a confidence score, and recommended strategy names.
 */
public final class RegimeClassification {
    ...
    private RegimeClassification(Builder builder) {
        ...
        this.recommendedStrategies = checkNotNull(builder.recommendedStrategies, "recommendedStrategies");
    }
    ...
    public String toString() {
        return String.format(
                "RegimeClassification{regime=%s, confidence=%.2f, adx=%.2f, atrPct=%.4f, bbWidthPct=%.4f, strategies=%s}",
    ...
    public static final class Builder {
        ...
        public Builder setConfidence(double confidence) {
            checkArgument(confidence >= 0.0 && confidence <= 1.0,
                    "Confidence must be between 0.0 and 1.0, got %s", confidence);
