...
class TiingoCryptoCandleTransformTest {
    ...
    fun setUp() {
        ...
        try {
            ...
            coderRegistry.registerCoderForClass(CurrencyPair::class.java, SerializableCoder.of(CurrencyPair::class.java))
        }
        try {
            ...
            coderRegistry.registerCoderForClass(Candle::class.java, SerializableCoder.of(Candle::class.java))
        }
    }
    ...
    fun `expand with PCollection input should fetch candles for each currency pair`() {
        ...
        val expectedOutput: List<KV<String, Candle>> =
            listOf(
