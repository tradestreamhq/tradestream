...
class CandleLookbackDoFnTest : Serializable { // Make test class serializable
    ...
    private val outputListCoder: Coder<ImmutableList<Candle>> =
        object : CustomCoder<ImmutableList<Candle>>() {
            private val listCoder: Coder<List<Candle>> = ListCoder.of(candleCoder)

            override fun encode(
                value: ImmutableList<Candle>,
    ...
    private val outputCoder: Coder<KV<String, KV<Int, ImmutableList<Candle>>>> =
        KvCoder.of(
            StringUtf8Coder.of(),
            KvCoder.of(VarIntCoder.of(), outputListCoder),
        )
