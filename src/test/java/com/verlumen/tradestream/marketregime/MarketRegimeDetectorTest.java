...
public class MarketRegimeDetectorTest {
    ...
    public void classify_rangingMarket_producesValidClassification() {
        MarketRegimeDetector rangingDetector = MarketRegimeDetector.builder()
                .setAdxTrendThreshold(20.0)
                .build();
    ...
    public void classify_highVolatility_hasSignificantAtr() {
        MarketRegimeDetector volDetector = MarketRegimeDetector.builder()
    ...
    public void classify_lowVolatility_hasSmallBbWidth() {
        MarketRegimeDetector quietDetector = MarketRegimeDetector.builder()
                .setAdxTrendThreshold(40.0)
    ...
    public void builder_customThresholds_respected() {
        MarketRegimeDetector custom = MarketRegimeDetector.builder()
                .setAdxPeriod(20)
                .setAtrPeriod(10)
                .setBbPeriod(30)
    ...
    private static BaseBar createBar(Instant endTime, double open, double high,
    ...
    private BarSeries buildStrongUptrendSeries() {
        ...
        for (int i = 0; i < 50; i++) {
            ...
            series.addBar(createBar(
                    time.plus(Duration.ofMinutes(i)),
                    price - 0.2, price + 0.5, price - 0.3, price, 1000.0));
        }
        return series;
    }
    ...
    private BarSeries buildStrongDowntrendSeries() {
        ...
        for (int i = 0; i < 50; i++) {
            ...
            series.addBar(createBar(
                    time.plus(Duration.ofMinutes(i)),
                    price + 0.2, price + 0.3, price - 0.5, price, 1000.0));
        }
        return series;
    }
    ...
    private BarSeries buildRangingSeries() {
        ...
        for (int i = 0; i < 50; i++) {
            ...
            series.addBar(createBar(
                    time.plus(Duration.ofMinutes(i)),
                    price, price + 0.5, price - 0.5, price, 1000.0));
        }
        return series;
    }
    ...
    private BarSeries buildHighVolatilitySeries() {
        ...
        for (int i = 0; i < 50; i++) {
            ...
            series.addBar(createBar(
                    time.plus(Duration.ofMinutes(i)),
                    price - 3.0, price + 10.0, price - 10.0, price, 2000.0));
        }
        return series;
    }
    ...
    private BarSeries buildLowVolatilitySeries() {
        ...
        for (int i = 0; i < 50; i++) {
            ...
            series.addBar(createBar(
                    time.plus(Duration.ofMinutes(i)),
                    price, price + 0.05, price - 0.05, price, 500.0));
        }
        return series;
    }
    ...
    private BarSeries buildTransitionSeries() {
        ...
        for (int i = 0; i < 35; i++) {
            ...
            series.addBar(createBar(
                    time.plus(Duration.ofMinutes(i)),
                    price, price + 0.3, price - 0.3, price, 1000.0));
        }
        ...
        for (int i = 35; i < 60; i++) {
            ...
            series.addBar(createBar(
                    time.plus(Duration.ofMinutes(i)),
                    price - 0.5, price + 1.0, price - 0.5, price, 1500.0));
        }
        return series;
    }
}
