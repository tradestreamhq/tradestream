...
public class RunBacktestTest {
  ...
  @Inject private RunBacktest runBacktest;
  ...
  public void testMultipleElementsProcessing() {
    List<BacktestRequest> requests =
        Arrays.asList(createDummyRequest(), createDummyRequest(), createDummyRequest());
  ...
  public void testNullElementProcessing() {
    ...
    assertThrows(
        ...
        () -> {
          pipeline.apply(Create.of((BacktestRequest) null)).apply(runBacktest);
