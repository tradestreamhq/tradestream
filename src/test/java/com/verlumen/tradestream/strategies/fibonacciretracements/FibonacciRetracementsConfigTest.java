...
public class FibonacciRetracementsConfigTest {
  ...
  public void setUp() throws Exception {
    config = StrategyConfigLoader.loadResource("strategies/fibonacci_retracements.yaml");
  ...
  public void createStrategy_returnsValidStrategy() {
    ...
    assertThat(strategy.getName()).isEqualTo("FIBONACCI_RETRACEMENTS");
  }

  @Test
  public void strategy_canEvaluateSignals() {
    Strategy strategy = factory.createStrategy(series, factory.getDefaultParameters());
    for (int i = 70; i < series.getBarCount(); i++) {
  ...
  public void defaultParameters_areWithinBounds() {
    ...
    assertThat(params.getIntValuesOrDefault("period", 0)).isIn(com.google.common.collect.Range.closed(20, 100));
  }
  ...
  public void createParameters_fromChromosomes_succeeds() throws Exception {
    ImmutableList<NumericChromosome<?, ?>> chromosomes = ImmutableList.of(
        IntegerChromosome.of(20, 100, 50));
