...
public class ElderRayMaConfigTest {
  ...
  public void setUp() throws Exception {
    config = StrategyConfigLoader.loadResource("strategies/elder_ray_ma.yaml");
  ...
  public void createStrategy_returnsValidStrategy() {
    ...
    assertThat(strategy.getName()).isEqualTo("ELDER_RAY_MA");
  }
