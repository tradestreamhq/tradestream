...
public class MacdCrossoverConfigTest {
  ...
  public void setUp() throws Exception {
    config = StrategyConfigLoader.loadResource("strategies/macd_crossover.yaml");
  ...
  public void createStrategy_returnsValidStrategy() {
    ...
    assertThat(strategy.getName()).isEqualTo("MACD_CROSSOVER");
  }
