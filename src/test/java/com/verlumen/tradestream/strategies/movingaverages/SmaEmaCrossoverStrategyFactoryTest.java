...
public class SmaEmaCrossoverStrategyFactoryTest {
  ...
  public void entryRule_shouldTrigger_whenSmaCrossesAboveEma() {
    ...
    assertThat(strategy.getEntryRule().isSatisfied(8)).isTrue();
  ...
  public void exitRule_shouldTrigger_whenSmaCrossesBelowEma() {
    ...
    assertThat(strategy.getExitRule().isSatisfied(12)).isFalse();
    // Exit rule should trigger at bar 13
    assertThat(strategy.getExitRule().isSatisfied(13)).isTrue();
  }

  @Test(expected = IllegalArgumentException.class)
  public void validateSmaPeriod() throws InvalidProtocolBufferException {
    params =
        SmaEmaCrossoverParameters.newBuilder().setSmaPeriod(-1).setEmaPeriod(EMA_PERIOD).build();
  ...
  public void validateEmaPeriod() throws InvalidProtocolBufferException {
    params =
        SmaEmaCrossoverParameters.newBuilder().setSmaPeriod(SMA_PERIOD).setEmaPeriod(-1).build();
    factory.createStrategy(series, params);
  }
