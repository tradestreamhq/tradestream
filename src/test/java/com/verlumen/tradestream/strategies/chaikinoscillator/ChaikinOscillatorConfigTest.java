...
public class ChaikinOscillatorConfigTest {
  ...
  public void setUp() throws Exception {
    config = StrategyConfigLoader.loadResource("strategies/chaikin_oscillator.yaml");
  ...
  public void createStrategy_returnsValidStrategy() throws Exception {
    ...
    assertThat(strategy.getName()).isEqualTo("CHAIKIN_OSCILLATOR");
  }
