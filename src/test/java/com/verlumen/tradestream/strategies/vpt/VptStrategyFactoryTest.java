...
public final class VptStrategyFactoryTest {

  private final VptStrategyFactory factory = new VptStrategyFactory();

  @Test
  public void getDefaultParameters_returnsExpectedParameters() {
    VptParameters parameters = factory.getDefaultParameters();
