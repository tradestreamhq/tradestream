...
public final class PvtParamConfigTest {

  private final PvtParamConfig config = new PvtParamConfig();
  ...
  public void createParameters_withValidChromosomes_returnsCorrectParameters()
    ...
    assertThat(result.is(PvtParameters.class)).isTrue();
    PvtParameters parameters = result.unpack(PvtParameters.class);
