...
public class GannSwingConfigTest {
  ...
  public void setUp() throws Exception {
    config = StrategyConfigLoader.loadResource("strategies/gann_swing.yaml");
  ...
  public void defaultParameters_areWithinBounds() {
    ...
    assertThat(params.getIntValuesOrDefault("gannPeriod", 0)).isIn(com.google.common.collect.Range.closed(5, 30));
  }
