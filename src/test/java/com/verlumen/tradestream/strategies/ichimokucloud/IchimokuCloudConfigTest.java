...
public class IchimokuCloudConfigTest {
  ...
  public void setUp() throws Exception {
    config = StrategyConfigLoader.loadResource("strategies/ichimoku_cloud.yaml");
  ...
  public void strategy_canEvaluateSignals() {
    Strategy strategy = factory.createStrategy(series, factory.getDefaultParameters());
    for (int i = 80; i < series.getBarCount(); i++) {
  ...
  public void defaultParameters_areWithinBounds() {
    ...
    assertThat(params.getIntValuesOrDefault("tenkanSenPeriod", 0)).isIn(com.google.common.collect.Range.closed(7, 12));
    assertThat(params.getIntValuesOrDefault("kijunSenPeriod", 0)).isIn(com.google.common.collect.Range.closed(20, 30));
  }
