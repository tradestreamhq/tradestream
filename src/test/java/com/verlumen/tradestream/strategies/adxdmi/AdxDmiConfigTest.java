...
public class AdxDmiConfigTest {
  ...
  public void setUp() throws Exception {
    config = StrategyConfigLoader.loadResource("strategies/adx_dmi.yaml");
  ...
  public void createStrategy_returnsValidStrategy() throws Exception {
    ...
    assertThat(strategy.getName()).isEqualTo("ADX_DMI");
  }
  ...
  public void createParameters_fromChromosomes_succeeds() throws Exception {
    ImmutableList<NumericChromosome<?, ?>> chromosomes =
        ImmutableList.of(IntegerChromosome.of(10, 30), IntegerChromosome.of(10, 30));
