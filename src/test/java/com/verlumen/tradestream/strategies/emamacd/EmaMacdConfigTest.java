...
public class EmaMacdConfigTest {
  ...
  public void setUp() throws Exception {
    config = StrategyConfigLoader.loadResource("strategies/ema_macd.yaml");
  ...
  public void createStrategy_returnsValidStrategy() {
    ...
    assertThat(strategy.getName()).isEqualTo("EMA_MACD");
  }
