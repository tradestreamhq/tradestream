...
public class HttpClientImplTest {
  ...
  public void get_throwsIOException_whenInputStreamFails() throws Exception {
    ...
    when(mockConnection.getResponseCode()).thenReturn(HttpURLConnection.HTTP_OK);
    when(mockConnection.getInputStream()).thenThrow(new IOException("Stream read error"));
  ...
  public void get_throwsIOException_whenCreatingConnectionFails() throws Exception {
    ...
    when(mockConnectionFactory.create(anyString())).thenThrow(new IOException("Connection failed"));
  ...
  public void get_throwsIOException_whenSetRequestMethodFails() throws Exception {
    ...
    doThrow(new ProtocolException("Invalid method")).when(mockConnection).setRequestMethod("GET");
