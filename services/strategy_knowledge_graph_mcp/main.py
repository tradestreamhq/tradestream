"""
Main application for the Strategy Knowledge Graph MCP server.
Connects to PostgreSQL, then serves MCP tools via stdio or SSE.
"""
...
async def main_async() -> None:
    """Main async function."""
    if not FLAGS.postgres_username or not FLAGS.postgres_password:
        logging.error("PostgreSQL username and password are required")
        sys.exit(1)
