...
class PredictionMarketSignalGeneratorTest(absltest.TestCase):
    ...
    def test_bullish_threshold_crossing(self):
        ...
        self.assertEqual(btc_signals[0].signal_type, SignalType.PROBABILITY_THRESHOLD)
    ...
    def test_bearish_threshold_crossing(self):
        ...
        threshold_signals = [
            s for s in signals if s.signal_type == SignalType.PROBABILITY_THRESHOLD
        ]
    ...
    def test_spike_detection(self):
        ...
        spike_signals = [
            s for s in signals if s.signal_type == SignalType.PROBABILITY_SPIKE
        ]
    ...
    def test_volume_anomaly_detection(self):
        ...
        volume_signals = [
            s for s in signals if s.signal_type == SignalType.VOLUME_ANOMALY
        ]
    ...
    def test_insider_alert_processing(self):
        ...
        insider_signals = [
            s for s in signals if s.signal_type == SignalType.INSIDER_ACTIVITY
        ]
