...
class IntegrationTest(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.mock_influx_client = patch('services.backtest_request_factory.influx_poller.InfluxDBClient').start()
        self.mock_kafka_producer = patch('services.backtest_request_factory.kafka_publisher.kafka.KafkaProducer').start()
    ...
    def test_error_handling_integration(self):
        ...
        self.mock_producer_instance.send.side_effect = Exception("Kafka connection failed")
    ...
    def test_fibonacci_window_request_generation(self):
        ...
        self.assertEqual(requests_per_candle[7], 2)  # 8th candle: 2 requests (5, 8 windows)
        self.assertEqual(requests_per_candle[12], 3)  # 13th candle: 3 requests (5, 8, 13 windows)
