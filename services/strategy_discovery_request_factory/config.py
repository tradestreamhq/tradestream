...
FIBONACCI_WINDOWS_MINUTES = [5, 8, 13, 21, 34, 55, 89, 144] # Kept shorter for cron job efficiency

# Maximum length of candle deques to prevent memory issues
DEQUE_MAXLEN = max(FIBONACCI_WINDOWS_MINUTES) + 10 # Ensure it's larger than the largest window
...
# Processing defaults
DEFAULT_LOOKBACK_MINUTES = 60 * 24 * 7  # How far back to look for candles on first run for a symbol (1 week)
