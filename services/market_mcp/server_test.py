...
class TestMarketMcpServer:
    ...
    @pytest.mark.asyncio
    async def test_get_candles_with_time_range(self, server, influxdb_client):
        """Test get_candles with start and end times."""
        influxdb_client.get_candles.return_value = []
    ...
    async def test_get_volatility(self, server, influxdb_client):
        ...
        request.params.arguments = {"symbol": "BTC/USD", "period_minutes": 60}
