...
_ENV_KEYS = ("LLM_MODEL_PRIMARY", "LLM_MODEL_LIGHTWEIGHT", "OPENROUTER_BASE_URL")
...
class TestModelConfig:
    ...
    def test_env_override_lightweight(self):
        ...
        with mock.patch.dict(
            os.environ, {"LLM_MODEL_LIGHTWEIGHT": "openai/gpt-4o-mini"}
        ):
            import importlib
    ...
    def test_env_override_base_url(self):
        ...
        with mock.patch.dict(
            os.environ, {"OPENROUTER_BASE_URL": "http://localhost:8080"}
        ):
            import importlib
